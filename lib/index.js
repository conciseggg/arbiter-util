...
exports.generateRandomBytesHex = exports.wait = undefined;
...
var generateRandomBytesHex = exports.generateRandomBytesHex = function () {
	...
	return function generateRandomBytesHex() {
...
function generateRandomInt() {
	...
	return Number(Math.random().toString().slice(2, 2 + size));
}
